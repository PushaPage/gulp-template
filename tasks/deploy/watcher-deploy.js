...
module.exports = function(options) {
	return function() {
		...
		gulp.watch(options.fontsWatch, gulp.series('fonts', 'deploy-add'))
			.on('unlink', function(filepath) {
